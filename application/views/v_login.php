...
<head>
  ...
  <!-- style -->
  <link rel="stylesheet" href="<?php echo base_url('assets/lte/') ?>/css/stylecustom.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('assets/lte/') ?>index2.html"><b>Book</b>TRAVEL</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a href="<?php echo base_url('Action/daftar') ?>" class="text-center">Buat akun</a>
